            		...
            		<div class="col-lg-12 col-md-12">
                              <div class="white-box analytics-info">
                                    <ul class="list-inline two-part d-flex align-items-center mb-0">
                                          ...
                                          <li class="ms-auto">
                                                <span class="counter text-info">R$10</span>
                                          </li>
                                    </ul>
                              </div>
                        </div>
            			...
            			<div class="white-box analytics-info">
            				<h3 class="box-title">Canais adicionados</h3>
            				<ul class="list-inline two-part d-flex align-items-center mb-0">
                                          <li>
                                                <i class="fa fa-tv fa-3x text-info"></i>
                                          </li>
                                          <li class="ms-auto">
                                                <span class="counter text-info">869</span>
                                          </li>
                                    </ul>
                              </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                              <div class="white-box analytics-info">
                                    <h3 class="box-title">Filmes adicionados</h3>
                                    <ul class="list-inline two-part d-flex align-items-center mb-0">
                                          <li>
                                                <i class="fa fa-film fa-3x text-info"></i>
                                          </li>
                                          <li class="ms-auto"><span class="counter text-info">869</span></li>
                                    </ul>
                              </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
